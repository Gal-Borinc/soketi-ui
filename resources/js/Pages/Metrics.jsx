...
// Enhanced formatting with better UX for different metric types
function fmt(val, type = 'number', digits = 2) {
    ...
    // Format bytes
    if (type === 'bytes') {
        if (n >= 1073741824) return (n / 1073741824).toFixed(digits) + ' GB/s';
        if (n >= 1048576) return (n / 1048576).toFixed(digits) + ' MB/s';
        if (n >= 1024) return (n / 1024).toFixed(digits) + ' KB/s';
        return n.toFixed(digits) + ' B/s';
    }
